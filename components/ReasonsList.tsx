...
const defaultReasons = [
  ...
  "You hold my hand like it matters.",
  "You understand my silences.",
  "You make ordinary days special.",
  "You inspire me to be better.",
  "You care for me so gently.",
  "You accept me, quirks and all.",
  "You are my best friend.",
  "You make home feel like heaven.",
  ...
  "You support my wild ideas.",
  "You hug me just right.",
  "You make every trip an adventure.",
  "You sing off-key and I still adore it.",
